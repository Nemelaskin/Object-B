    ...
    public static class SampleData
    {
        public static void Initialize(AllDataContext context)
        {
            if (!context.Roles.Any() && !context.Companies.Any() && !context.Rooms.Any())
            {
                ...
                var room1 = new Room { NameRoom = "testRoom", CoordinatesRoom = "22 22 11" };
                ...
                var sensor1 = new Sensor { User = user1, Coordinates = "5.5.5", NameSensor = "testsen3" };
                var sensor2 = new Sensor { User = user2, Coordinates = "3.3.3", NameSensor = "testsen2" };
                var sensor3 = new Sensor { User = user3, Coordinates = "4.4.4", NameSensor = "testsen1"};
